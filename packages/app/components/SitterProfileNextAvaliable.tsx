  ...
  return (
    <View>
      ...
      <Box className="border-2">
        ...
        <View className="flex-row justify-center">{getAvailability(props.available[0])}</View>
        <Text className="text-lg">Tuesday</Text>
        <View className="flex-row justify-center">{getAvailability(props.available[1])}</View>
        <Text className="text-lg">Wednesday</Text>
        <View className="flex-row justify-center">{getAvailability(props.available[2])}</View>
      </Box>
    </View>
  )
}
