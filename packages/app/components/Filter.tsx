...
import { Box, Select, FormControl, Text, Button, Input, HStack, CheckIcon, Slider, NativeBaseProvider , VStack} from "native-base";
        ...
        <Box>
            ...
            <FormControl isRequired>
                <VStack space={4} className="mt-8 mx-8">
                    ...
                    <Input placeholder="Select day" keyboardType='numeric' onPressIn={() => {setShowDate(true)}} value={date.toLocaleDateString()}/>
                    ...
                    <Box maxW="full">
                        <Select selectedValue={frequency} minWidth="full" accessibilityLabel="Choose availability" placeholder="Choose availability" _selectedItem={{
                        bg: "teal.600",
                        endIcon: <CheckIcon size="5" />
                    ...
                    <Box alignItems="center" w="100%">
                        <HStack>
                            <Slider 
                                ...
                                step={10}
                                onChange={v => { setProximity(Math.floor(v)); }}
                ...
                />
                <Button className="w-[300px] m-auto mt-10" onPress={() => handleSubmit({date: date.toLocaleDateString(), frequency, service, proximity})}>Submit</Button>
            </FormControl>
        </Box>
    )
  }