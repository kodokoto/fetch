...
function DaySelectButton({ day, value, onChange, roundedLeft = false, roundedRight = false }: { day: string, value: boolean, onChange: (day: string,value: boolean) => void, roundedLeft?: boolean, roundedRight?: boolean }) {
...
export default function AvailableDaySelect({value, onChange} : {value: AvailableDays, onChange: (value: AvailableDays) => void}) {
