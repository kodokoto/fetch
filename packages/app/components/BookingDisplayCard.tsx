...
export default function BookingDisplayCard(props: EditableDisplayCard<Booking>) {
  ...
  const { data: userData, isLoading: userDataIsLoading } = session.currentProfile === Profile.SITTER 
  ...
  return (
    ...
    <Button 
      onPress={handlePress}
      className='w-10/12 mx-auto rounded-3xl bg-gray-100 shadow-sm p-4 py-0 my-4'>
