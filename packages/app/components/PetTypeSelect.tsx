...
export default function PetTypeSelect({value, onChange, toggle=false} : {value: AvailablepetType, onChange: (value: AvailablepetType) => void, toggle?: boolean}) {
...
function AnimalSelectButton({ animal, value, onChange, Icon }: { animal: string, value: boolean, onChange: (animal: string,value: boolean) => void, Icon?: ComponentType<any>}) {
