...
export default function PetTypeSelect({value, onChange} : {value: AvailablepetType, onChange: (value: AvailablepetType) => void}) {
    ...
    return (
        <View className='flex-row justify-center divide-x-8 '>
            <AnimalSelectButton animal='DOG' value={value.DOG} onChange={handleChange} icon={ <FontAwesome5 name="dog" size={16} color="black" />}/>
            <AnimalSelectButton animal='CAT' value={value.CAT} onChange={handleChange} icon={ <FontAwesome5 name="cat" size={16} color="black" />}/> 
