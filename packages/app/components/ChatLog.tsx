  ...
  return (
    <KeyboardAwareScrollView keyboardShouldPersistTaps={'always'}>
      {props.messages.map((message, index) => {
        ...
        return (
          (
            <ChatMessage key={message.createdAt} showDatestamp={datesAreEqual} day={weekday[new Date(message.createdAt).getDay()]} timestamp={message.createdAt} messageContent={message.content} messageByAuthor={message.senderId == props.uid ? true : false} />
          )
        )
      })}
