      ...
      <View className="bg-transparent flex-1">
          ...
          <View className="flex-1 flex-col justify-center">
            ...
            <View className="bottom-12 flex-1">
              <View className="flex flex-col gap-1 text-black mx-6 mb-4">
                <Image source={{ uri: sitterData.imageUrl }} className="w-16 h-16 rounded-full border-white border-2" />
                <View className="flex-row justify-between">
                  <View className="flex-col justify-evenly">
                    ...
                    <View className="flex-row items-center">
                      ...
                      <ProfileRating
                        className="mt-auto"
                        rating={averageRating && Number(Number(averageRating).toFixed())}
                      />
                    </View>
                  </View>
                    ...
                    <View className="flex flex-row justify-between items-center">
                      ...
                      <Menu
                        ...
                        trigger={(triggerProps) => {
                          return (
                            <Pressable {...triggerProps} className="mr-2">
        ...
        {serviceType && day && timeOfDay && session.currentProfile === Profile.OWNER ? (
          <View className="absolute bottom-0 w-full h-20 bg-transparent">
            <Button
              className="fixed bottom-0 rounded-full w-11/12 m-auto mb-8 h-10 bg-blue-500"
              onPress={() =>
                router.push({
