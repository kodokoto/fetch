  ...
  return (
    <Box flex={1} bg="#fff" p={4}>
      <ScrollView>
        ...
        <Text className="mt-5">
          By accessing this application we assume you accept these terms and conditions. Do not continue to use Fetch if
        ...
        <Text className="mt-3">
          Unless otherwise stated, Fetch and/or its licensors own the intellectual property rights for all material on
          Fetch. All intellectual property rights are reserved. You may access this from Fetch for your own personal use
        ...
        <Text className="mt-3">
          ...
          areas of the website. Fetch does not filter, edit, publish or review Comments prior to their presence on the
          website. Comments do not reflect the views and opinions of Fetch,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
          applicable laws, Fetch shall not be liable for the Comments or for any liability, damages or expenses caused
          and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
        </Text>
        <Text className="mt-3">
          Fetch reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <Text className="mt-3">
          We reserve the right to request that you remove all links or any particular link to our application. You
          approve to immediately remove all links to our application upon request. We also reserve the right to amen
          these terms and conditions and it's linking policy at any time. By continuously linking to our application,
